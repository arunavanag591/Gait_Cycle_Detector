...
//This function is used to input data points into the classifier.When a state is recognized, the members of 
//state_info is updated and the function returns true. This function is powered by the state machine
bool gait_detector::intake_data(int ay_value, int gy_value, unsigned int time_value, State_recognized_info & state_info){
