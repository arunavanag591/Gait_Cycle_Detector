...
//This struct represents one state of the state machine. It contains information on the current state, 
//the index of the next state, and the criteria (features) required to change to the next state
struct State {
...
//This function is used to input data points into the classifier. When a state is recognized, the members of state_info 
//is updated and the function returns true. This function is powered by the state machine
...
//This function sets each state in the state machine, including the state's name, the criteria to change to the next state,
